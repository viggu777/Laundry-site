      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Your trusted partner for a modern, hassle-free laundry experience.
              We offer eco-friendly and fast solutions.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-300">123 Laundry Street</p>
              ...
              <div className="flex items-center">
                ...
                <p className="text-gray-300">support@laundry.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} CleanCare Laundry. All rights
            reserved.
          </p>
