...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-600 p-4 flex justify-between items-center">
      <div className="text-white font-bold text-xl">Laundry Service</div>
      <div className="space-x-4">
        ...
        <Link className="text-white hover:underline" to="/laundry-booking-form">
          Book
        </Link>
        {currentUser ? (
          <>
          ...
          <>
            ...
            <Link className="text-white hover:underline" to="/admin-login">
              Admin-Login
            </Link>
